        ...
        do {
            ...
            for (int i = 0; i < customers.size(); i++) {
                ...
                if ((cust.getpassword() == password)) {
                    ...
                    //String startcustbalancestr= String.format("%2f", cust.getcredit());
                    System.out.println("you have the following credit " + df2.format(cust.getcredit()));
                    break;
                }
            ...
            do {
                ...
                for (int i = 0; i < producttypes.size(); i++) {
                    ...
                    if ((prod.getDescription().equals(prodtobuy))) {
                        ...
                        System.out.println("Your account has been updated your new balance is " + df2.format(newcustbalance));
